                    ...
                    <TableBody>
                      {admissions.map((admission) => (
                        ...
                        >
                          ...
                          <TableCell>{getStatusChip(admission.status)}</TableCell>
                            ...
                            {admission.status === "pending" ? (
                              ...
                              <Tooltip title="Delete">
                                <IconButton
                                  color="error"
                                  size="small"
                                  onClick={(e) => handleDeleteClick(admission, e)}
                                >
                                  <DeleteIcon />
                                </IconButton>
                              </Tooltip>
                    ...
                    <Table size="small">
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>{selectedSubmission.dateOfBirth}</TableCell>
                        </TableRow>
                        <TableRow>
                        ...
                        <TableRow>
                          ...
                          <TableCell>{selectedSubmission.previousSchool}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell component="th">Grade Applying For</TableCell>
                          <TableCell>{selectedSubmission.gradeApplying}</TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                  </TableContainer>
                    ...
                    <Table size="small">
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>{selectedSubmission.parentPhone}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell component="th">Parent Email</TableCell>
                          <TableCell>{selectedSubmission.parentEmail}</TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                  </TableContainer>
                  ...
                  <TableContainer component={Paper} variant="outlined">
                    <Table size="small">
                      <TableBody>
                        ...
                        <TableRow>
                          <TableCell component="th">Phone</TableCell>
                          <TableCell>{selectedSubmission.phone || "N/A"}</TableCell>
                        </TableRow>
                        <TableRow>
                        ...
                        <TableRow>
                          ...
                          <TableCell>{formatDate(selectedSubmission.submittedAt)}</TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                  </TableContainer>
            ...
            <DialogActions>
              ...
              {tabValue === 1 && selectedSubmission.status === "pending" && (
                <Button
                  color="info"
                  onClick={() => {
                    handleUpdateStatus(selectedSubmission.id, "processed", false);
                    handleCloseDetails();
                  }}
                >
                  Mark Processed
